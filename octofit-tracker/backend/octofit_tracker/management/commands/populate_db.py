...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Workouts
        Workout.objects.create(name='Iron Circuit', description='Strength and endurance')
        Workout.objects.create(name='Bat HIIT', description='High intensity interval training')
